...
def task_13_list_products_from_sweden_suppliers(cur):
    ...
    cur.execute("""
        ...
        FROM Suppliers WHERE Country = "Sweden");
    """)
...
def task_15_list_customers_with_any_order_or_not(cur):
    ...
    cur.execute("""
           ...
           Customers.Country, Orders.OrderID, FROM Customers, 
...
def task_16_match_all_customers_and_suppliers_by_country(cur):
    ...
    cur.execute("""
            ...
            S.Country AS SupplierCountry, S.SupplierName FROM Customers AS C
            FULL JOIN Suppliers AS S ON C.Country = S.Country ORDER BY 
